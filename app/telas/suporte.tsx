...
export default function SuporteScreen() {
  ...
  const enviarTicket = async () => {
    if (!mensagem.trim()) {
      showToast("Digite sua mensagem", "info");
      return;
    }
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={styles.emptyText}>
              Nenhuma solicitação aberta. Como podemos ajudar hoje?
            </Text>
          }
        />
      )}
            ...
            <View style={styles.radioGroup}>
              {["duvida", "sugestao_produto", "bug"].map((tipo) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.radioBtn,
                    tipoSelecionado === tipo && styles.radioBtnActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.radioText,
                      tipoSelecionado === tipo && styles.radioTextActive,
                    ]}
                  >
