...
import { StyleSheet, TouchableOpacity, ScrollView, Image, TextInput, Alert, Dimensions } from 'react-native';
...
export default function PostagensScreen() {
  ...
  /**
   * capturarFoto - Abre a câmera apenas para FOTO
   */
  ...
  /**
   * gravarVideo - Abre a câmera apenas para VÍDEO
   */
  ...
  /**
   * selecionarGaleria - Abre a galeria para TUDO (Fotos e Vídeos)
   */
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.createPostCard}>
          <Text style={styles.sectionTitle}>Nova Postagem</Text>
          ...
          <View style={styles.imageSelector}>
            {imagem ? (
              ...
              <View style={styles.imagePlaceholder}>
                <Ionicons name="videocam-outline" size={50} color="#2E7D32" />
                <Text style={styles.imagePlaceholderText}>Crie um novo conteúdo</Text>
              </View>
            )}
          </View>

          {/* Três botões separados para garantir estabilidade */}
          <View style={styles.mediaButtonsRow}>
            <TouchableOpacity style={[styles.mediaBtn, styles.shadow]} onPress={capturarFoto}>
              <Ionicons name="camera" size={20} color="#FFF" />
              <Text style={styles.mediaBtnText}>Foto</Text>
            </TouchableOpacity>

            <TouchableOpacity style={[styles.mediaBtn, { backgroundColor: '#EF6C00' }, styles.shadow]} onPress={gravarVideo}>
              <Ionicons name="videocam" size={20} color="#FFF" />
              <Text style={styles.mediaBtnText}>Vídeo</Text>
            </TouchableOpacity>
            
            <TouchableOpacity style={[styles.mediaBtn, { backgroundColor: '#1976D2' }, styles.shadow]} onPress={selecionarGaleria}>
          ...
          <TextInput
            ...
            placeholder="O que está acontecendo na quitanda agora?"
            multiline
            value={legenda}
            onChangeText={setLegenda}
          />
          
          <TouchableOpacity style={styles.postButton} onPress={publicar}>
            <Text style={styles.postButtonText}>Publicar na Vitrine</Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  mediaButtonsRow: { flexDirection: 'row', gap: 8, marginBottom: 15, backgroundColor: 'transparent' },
  ...
  postButton: { backgroundColor: '#2E7D32', padding: 16, borderRadius: 12, alignItems: 'center', marginTop: 10 },
