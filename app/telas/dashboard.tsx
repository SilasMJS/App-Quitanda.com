...
export default function DashboardScreen() {
    ...
    useCallback(() => {
      async function loadData() {
        try {
          ...
          if (
            userData?.tipo?.toUpperCase() === "ADMIN" ||
            userData?.tipo?.toUpperCase() === "VENDEDOR"
          ) {
            const reservas = await reservasService
              .listarRecebidos()
              .catch(() => []);
  ...
  const sellerMenuItems = [
    ...
    {
      label: "Reservas",
      route: "/telas/reservas",
      badge: countReservas > 0 ? countReservas : null,
      icon: "calendar",
    },
    {
      label: "Produtos",
      route: "/telas/produtos",
      badge: null,
      icon: "basket",
    },
    {
      label: "Pagamentos",
      route: "/telas/pagamentos",
      badge: countPagamentos > 0 ? countPagamentos : null,
      icon: "wallet",
    },
    {
      label: "Suporte",
  ...
  const adminMenuItems = [
    ...
    {
      label: "CATÁLOGO",
      route: "/telas/admin/produtos-base",
      icon: "basket",
      color: "#0288D1",
    },
    {
      label: "VENDEDORES",
      route: "/telas/admin/vendedores",
      icon: "people",
      color: "#01579B",
    },
    {
      label: "USUÁRIOS",
      route: "/telas/admin/usuarios",
      icon: "person",
      color: "#455A64",
    },
    {
      label: "CATEGORIAS & TIPOS",
      route: "/telas/admin/categorias",
      icon: "list",
      color: "#00796B",
    },
    {
      label: "SUPORTE",
      route: "/telas/admin/suporte",
      icon: "headset",
      color: "#D32F2F",
    ...
    <View style={styles.container}>
      ...
      >
        ...
        {isAdmin && hasStore && (
          <TouchableOpacity
            style={{
              backgroundColor: isAdminView ? "#2E7D32" : "#1976D2",
              padding: 12,
              borderRadius: 10,
              alignItems: "center",
              marginBottom: 20,
          ...
          >
            <Text style={{ color: "#FFF", fontWeight: "bold" }}>
              {isAdminView
                ? "ALTERAR PARA MINHA QUITANDA"
                : "ALTERAR PARA PAINEL ADMIN"}
            </Text>
          </TouchableOpacity>
        )}
              ...
              {adminMenuItems.map((item, index) => (
                ...
                >
                  <Ionicons
                    ...
                    color={item.color}
                  />
                  <Text style={[styles.adminMenuBtnText, { flex: 1 }]}>
                    {item.label}
                  </Text>
                  {item.badge && (
                    <View
              ...
              >
                ...
                >
                  ...
                  <Text style={styles.incompleteSubtitle}>
                    Complete sua vitrine para começar a vender no app.
                  </Text>
                </View>
